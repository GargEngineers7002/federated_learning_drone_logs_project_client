# -*- coding: utf-8 -*-
"""Matrice 600 - Refactored for Deployment"""
...
def preprocess(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # 4. EXACT features from 20Jan/matrice_600/preprocced_dataset.csv (56 cols)
    selected_features = [
        ...
        "IMU_ATTI(2):distanceTravelled:C",
        "IMU_ATTI(1):alti:D",
        "IMU_ATTI(2):alti:D",
        "IMUCalcs(0):height:C",
        "IMUCalcs(1):height:C",
        ...
        "IMUCalcs(2):totalGyroX:C",
        "IMUCalcs(2):totalGyroY:C",
        "IMUCalcs(2):totalGyroZ:C",
        "ATTI_MINI0:roll:C",
        "ATTI_MINI0:pitch:C",
        "ATTI_MINI0:yaw:C",
        "IMU_ATTI(0):quatW:D",
